package io.spring.multithreaded.processor;

import io.spring.multithreaded.domain.ImageSubmission;
import io.spring.multithreaded.domain.ProcessedImage;
 ...
 * the provides {@link io.spring.multithreaded.domain.ImageSubmission}, returning the
 * processed representation as a {@link io.spring.multithreaded.domain.ProcessedImage}.
 * </p>
 */
